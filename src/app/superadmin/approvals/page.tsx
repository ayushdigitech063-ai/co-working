...
export default function SuperAdminApprovalsPage() {
  ...
  const handleApprove = async (id: string) => {
    ...
    try {
      ...
      showSuccessAlert("Content Approved! 🎉", "The item has been published live to the public website.");
      fetchApprovals();
    } catch (err: any) {
      showErrorAlert("Approval Failed", err?.response?.data?.message || "Failed to approve content.");
    } finally {
  ...
  const handleConfirmReject = async (e: React.FormEvent) => {
    ...
    try {
      ...
      showSuccessAlert("Content Rejected", "The submission was marked as rejected.");
      setRejectingItem(null);
      setRejectionReason("");
      fetchApprovals();
    } catch (err: any) {
      showErrorAlert("Rejection Failed", err?.response?.data?.message || "Failed to reject content.");
    } finally {
  ...
  return (
    <div className="space-y-8 w-full font-sans">
      ...
      <div>
        ...
        <h1 className="text-3xl font-serif font-bold text-neutral-950 mt-1">Content Approvals Queue</h1>
